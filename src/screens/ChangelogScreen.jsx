...
const VERSIONS = [
  {
    ...
    changes: [
      { type: 'new', text: 'One deletion per day — posts can only be deleted once per day to prevent delete-and-repost spam' },
      { type: 'improved', text: 'Search results appear live as you type — no Enter or button needed' },
